...
\begin{Solucion}
  El pastel primero subió $(0.25)(200)=\frac{200}{4}=50$ pesos, por lo
  que el nuevo precio era $200+50=250$ pesos. Queremos ahora saber qué
...
\begin{Solucion}
  Como cada jugador juega contra otros siete, en principio serían
...
\begin{Solucion}
  Las solucion a la ecuación cuadrática $n^{2}-n+1=91$ son $n=10$,
  $n=-9$, por lo que 91 ocupa el índice 10 en la sucesión, y el
  siguiente número corresponde al $n=11$, es decir $11^{2}-11+1=111$.
\end{Solucion}
...
\begin{Solucion}
  Si el tercer tigre tragó $x$ trastos, el segundo tragó $3x$ y el
  primero tragó $2(3x)=6x$. Es decir, en total se tragaron
...
\begin{Solucion}
  Los únicos posibles valores para las longitudes de los lados son:
  21,1 o 3,7.
\end{Solucion}
...
\begin{Solucion}
  Sea $r$ el radio del círculo. Queremos entonces expresar el área del
  triángulo en función de $r$, y para eso necesitamos a su vez
  expresar la base y la altura en función de $r$.

  Partiendo del centro del círculo y trazando una perpedicular a un
  lado, formamos un pequeño triángulo rectángulo que tiene un radio
  $r$ como hipotenusa. Dado que el triángulo original es equilátero,
  el segmento perpendicular trazado mide $\frac{r}{2}$, y por lo tanto
  el otro cateto mide $\frac{r\sqrt{3}}{2}$. Dado que este último
  cateto mide la mitad del lado del triángulo original, tenemos que el
  triángulo original tiene lado $r\sqrt{3}$ y altura $\frac{3r}{2}$,
  de donde se obtiene:
  \begin{equation}
    \label{eq:5}
    r^{2}=\frac{4}{3\sqrt{3}}.
  ...
  Por lo tanto, el área del círculo es $\pi\frac{4}{3\sqrt{3}}$, y el
  área sombreada es $\frac{4\pi}{3\sqrt{3}}-1$.
\end{Solucion}
